...
def run_migrations_offline() -> None:
    """Configure Alembic to emit SQL without opening a DB connection."""
...
def run_migrations_online() -> None:
    ...
    configuration: dict[str, Any] = config.get_section(config.config_ini_section, {})  # type: ignore[arg-type]
